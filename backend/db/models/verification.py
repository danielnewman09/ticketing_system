...
class VerificationMethod(Base):
    ...
    actions: Mapped[list[VerificationAction]] = relationship(
        "VerificationAction", back_populates="verification", cascade="all, delete-orphan"
    )
...
class VerificationCondition(Base):
    ...
    verification: Mapped[VerificationMethod] = relationship(
        "VerificationMethod", back_populates="conditions"
    )
...
class VerificationAction(Base):
    ...
    verification: Mapped[VerificationMethod] = relationship(
        "VerificationMethod", back_populates="actions"
    )
    ontology_node: Mapped[Optional[OntologyNode]] = relationship("OntologyNode")
...
VerificationMethod.task_links = relationship(
    "TaskVerification",
    back_populates="verification_method",
)
