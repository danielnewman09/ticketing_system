...
Provides ProjectMeta, Component, Language, Dependency, HLR, and LLR node
models for the ticketing system's project-management layer. These extend
CodeGraphNode from codegraph to share serialization, registry, and
relationship introspection infrastructure, while living in the same Neo4j
database as code-level nodes (ClassNode, NamespaceNode, etc.).
