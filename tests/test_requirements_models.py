...
# ---------------------------------------------------------------------------
# HLR ↔ OntologyNode M2M relationship removed in Phase 1.
# HLR/LLR now link to design nodes via TRACES_TO edges in Neo4j.
# See backend/db/neo4j/repositories/design.py
